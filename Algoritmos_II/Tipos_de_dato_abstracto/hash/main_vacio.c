...
{
	printf("\nINICIO DE PRUEBA INSERTAR\n");
    hash_t* hash = hash_crear(NULL);

    char *clave1 = "perro", *valor1 = "guau";
    char *clave2 = "gato", *valor2 = "miau";
    char *clave3 = "vaca", *valor3 = "mu";
    char *clave4 = "hola", *valor4 = "chau";
    char *clave5 = "holas", *valor5 = "chaus";
    char *clave6 = "holaa", *valor6 = "chaua";
    char *clave7 = "holasd", *valor7 = "chaus";
    char *clave8 = "holaf", *valor8 = "chaua";
    char *clave9 = "holafe", *valor9 = "chauaf";
    char *clave10 = "holafs", *valor10 = "chauas";
    char *clave11 = "holafd", *valor11 = "chauaa";
    ...
    print_test("Prueba hash insertar clave10", hash_guardar(hash, clave10, valor10));
    print_test("Prueba hash insertar clave11", hash_guardar(hash, clave11, valor11));
...
{
	printf("\nINICIO DE PRUEBA REEMPLAZAR CON DESTRUIR\n");
...
{
	printf("\nINICIO DE PRUEBA CON VALOR NULL\n");
    hash_t* hash = hash_crear(NULL);
...
// {
//     printf("\n\nINICIO DE PRUEBAS ITERAR COMUN\n\n");
//     hash_t* hash = hash_crear(NULL);
...
//     printf("\n\n DEBUG: Mepa que explota en ver actual \n\n");
...
//     printf("\n\nINICIO DE PRUEBAS ITERAR VOLUMEN\n\n");
//     hash_t* hash = hash_crear(NULL);
