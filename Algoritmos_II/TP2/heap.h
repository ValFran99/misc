...
// Esta modificación es para poder cambiar la firma de la función de comparación, por si no solo tengo que comparar
// los dos valores que recibo sino que también tengo información en una base de datos extra
// Luego hay que modificar la documentación y eso
 ...
 *   mayor a 0  si  a > b
 */
typedef int (*cmp_func_t)(const void *a, const void *b, const void* extra_data);
